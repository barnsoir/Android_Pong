...
class PongGame extends SurfaceView implements Runnable{
    ...
    public PongGame(Context context, int x, int y) {
        ...
        // Initialise these two members/fields with the values passed in as parameters
        mScreenX = x;
        mScreenY = y;
        ...
        // Initialise the objects ready for drawing with
        ...
        // Open each of hte sound files in turn and load them into RAM ready to play
        // The try-catch blocks handle when this fails and are required
        try {
    ...
    public void run() {
        ...
        while (mPlaying) {
            ...
            if (timeThisFrame > 0) {
                // Store the current frame rate in mFPS ready to pass to the update methods
                // of mBat and mBall next frame/loop
